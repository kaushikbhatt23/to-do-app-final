...
exports.Cards = function () {
    ...
    return (React.createElement("div", { className: "card-container" }, sortedData.map(function (item) { return (React.createElement(IndividualCard_1["default"], { key: item.id, todo: item })); })));
};
